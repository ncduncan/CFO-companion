...
const generateDummyRecords = (productCodes: string[], ccCodes: string[]): FinancialRecord[] => {
...
export const INITIAL_DATA: AppData = {
  ...
  records: generateDummyRecords(PROD_LINES.map(p => p.code), COST_CENTERS.map(c => c.code)),
  opportunities: [
    {
      id: 'opp-1',
