            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 border border-dashed border-slate-300 rounded bg-slate-50 flex flex-col items-center justify-center text-center">
                  ...
                  <label className="cursor-pointer bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 px-4 py-2 rounded text-sm font-medium shadow-sm transition-colors">
                        ...
                        reader.onload = (ev) => {
                          try {
                            ...
                            if (content.records && Array.isArray(content.records)) {
                              ...
                              alert(`Successfully imported ${content.records.length} records.`);
                            } else {
                              alert("Invalid file format. Expected JSON with a 'records' array.");
                            }
                          } catch (err) {
